  ...
  return (
    <Space wrap>
      <Collapse
        ...
        defaultActiveKey={["job_category", "employment_type", "rank_by"]}
        style={{ ...s.collapse, width: sidebarSize }}
      >
        <Panel header="Job Category" key="job_category">
          {[
            ...
            {
              value: "job_distributionshipping",
            ...
            {
              value: "job_restaurantfoodservice",
        ...
        <Panel header="Employment Type" key="employment_type">
          <Form.Item>
            {[
              ...
              { value: "employ_parttime", label: "Part-time" },
            ].map((item) => {
              return (
                <Row>
                  <Col span={24}>
        ...
        <Panel header="Rank by" key="rank_by">
          <Radio.Group value={query.rank_by} onChange={onRankByChange}>
            {[
              ...
              {
                value: "-monthly_salary_median",
                label: "Monthly salary median",
              },
            ].map((item) => {
              return (
                <Row>
                  <Col span={24}>
                    <Radio name={item.value} value={item.value}>
                      {item.label}
                    </Radio>
                  </Col>
                </Row>
